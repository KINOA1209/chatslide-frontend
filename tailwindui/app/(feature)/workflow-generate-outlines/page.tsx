...
import MyCustomJoyride from './CustomJoyrideComponent';
...
export default function Topic() {
    ...
    const [addEquations, setAddEquations] = useState(
        typeof window !== 'undefined' &&
            sessionStorage.addEquations != undefined
            ...
            if (userId) {
                ...
                if (data) {
                    ...
                    setAudienceSuggestions(
                        Array.from(uniqueAudiences) as string[]
                    );
                }
            }
        };
    ...
    async function addYoutubeLink(link: string) {
        try {
            const { userId, idToken } =
                await AuthService.getCurrentUserTokenAndId();
            const videoDetails = await YoutubeService.getYoutubeInfo(
                link,
                idToken
            );
    ...
    const handleSubmit = async () => {
        ...
        if (topic.length < MIN_TOPIC_LENGTH) {
            setTopicError(
                `Please enter at least ${MIN_TOPIC_LENGTH} characters.`
            );
            toast.error(
        ...
        const project_id =
            typeof window !== 'undefined' &&
            sessionStorage.project_id != undefined
        ...
        try {
            ...
            if (response.ok) {
                ...
                sessionStorage.setItem(
                    'outline',
                    JSON.stringify(outlinesJson.data)
                );
                sessionStorage.setItem(
                    'foldername',
                    outlinesJson.data.foldername
                );
                sessionStorage.setItem(
                    'project_id',
                    outlinesJson.data.project_id
                );
                sessionStorage.setItem(
                    'pdf_images',
    ...
    return (
        <section>
            ...
            <WorkflowStepsBanner
                ...
                showGPTToggle={true}
                nextText={
                    !isSubmitting ? 'Write Outline' : 'Writing Outline...'
                }
                            ...
                            <div className='relative inline-block'>
                                ...
                                >
                                    ...
                                    {showProjectPopup && (
                                        ...
                                        >
                                            The main subject or theme of your
                                            project. It will set the direction
                                            and focus of the contents.
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className='textfield'>
                            ...
                            ></textarea>
                            {
                                <div className='text-gray-500 text-sm mt-1'>
                                    {MAX_TOPIC_LENGTH - topic.length} characters
                                    left
                                </div>
                            }
                            {topicError && (
                                    ...
                                    <div className='relative inline-block'>
                                        ...
                                        >
                                            ...
                                            {showAudiencePopup && (
                                                ...
                                                >
                                                    Specify the intended viewers
                                                    of your projects, tailoring
                                                    to your audience ensures the
                                                    content resonates
                                                    effectively.
                                                </div>
                                            )}
                            ...
                            <div className='w-full px-3 mt-2 flex flex-row'>
                                <div className='flex items-center'>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setAddEquations(e.target.checked)
                                        }
                                    />
                                </div>
                                <label
                                ...
                                >
                                    Select to <b>add equations and formulas</b>{' '}
                                    to my content, recommended for Math/Science
                                    subjects
                                </label>
                            </div>
                        </div>
                    ...
                    <div className='additional_container my-2 lg:my-5  border border-2 border-gray-200'>
                            ...
                            <div className='relative inline-block'>
                                ...
                                >
                                    ...
                                    {showSupportivePopup && (
                                        ...
                                        >
                                            Any additional files that can
                                            enhance and provide context to your
                                            projects. This could be research
                                            data, images, charts, or reference
                                            materials.
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className='drop_file bg-gray-100 border border-2 border-gray-200'>
                            <div className='flex items-center w-full'>
                                <FaFilePdf />
                                <span className='text-sm md:text-l'>
                                    Drop files here or{' '}
                                </span>
