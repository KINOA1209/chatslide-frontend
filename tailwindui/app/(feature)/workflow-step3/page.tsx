...
const OutlineVisualizer = ({slide}: { slide: any }) => {
    console.log(slide);
...
//     };
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            localStorage.setItem('slide', JSON.stringify(slide.data));
 ...
 <div>
        <h2>Text:</h2>
        <textarea
          className="w-full px-3 py-2 mt-2 text-gray-700 border rounded-lg focus:outline-none focus:shadow-outline"
