...
export default function ResetPassword(): JSX.Element {
  ...
  const handleSendResetLink = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    e.preventDefault();
  ...
  const handleResetPassword = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    e.preventDefault();
    try {
      await AuthService.forgotPasswordSubmit(email, confirmationCode, newPassword);
      // Reset password successful
      console.log('Password reset successful');

      toast.success('reset password successfully, redirecting to sign in page', {
        position: "top-center",
        autoClose: 2000,
