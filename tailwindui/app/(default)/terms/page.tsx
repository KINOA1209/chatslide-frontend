			...
			<div className='max-w-6xl mx-auto px-4 sm:px-6'>
				<div className='pt-32 pb-12 md:pt-40 md:pb-20'>
					...
					<div className='max-w-3xl mx-auto text-center pb-12 md:pb-16'>
						<BigTitle center>Terms and Conditions</BigTitle>
					</div>
					...
					<div className='max-w-3xl mx-auto pb-4'>
						...
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								2.1 Automation Restrictions: The use of robots, spiders, or any
								other automated means to access the Service is strictly
								prohibited unless specifically authorized by us. This includes
								any automation used for scraping, data mining, or any other
								activity that imposes an unreasonable or disproportionately
								large load on our infrastructure.
							</p>
						</div>
						<div className='pb-0'>
							<p className='text-base text-gray-600'>
								2.2 System Integrity: You must not undertake any action that
								could harm the integrity or performance of the Service.
								Activities such as exploiting vulnerabilities, distributing
								malware, or engaging in any form of system interference or
								disruption are strictly prohibited. We reserve the right to
								investigate and take appropriate legal action against anyone
								who, in our sole discretion, violates this policy, including
								without limitation, removing the offending communication from
								the Service and terminating the violator's access to the site.
							</p>
						</div>
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								2.3 Account Non-transferability: Users are prohibited from
								giving, selling, or renting their account to anyone else. Your
								account is personal to you and granting access to your account
								to others, or transferring ownership of your account,
								compromises the security of the Service and is strictly
								forbidden. Violation of this policy may result in immediate
					...
					<div className='max-w-3xl mx-auto pb-4'>
						<div className='pb-8'>
							<h2 className='h3 text-2xl'>
								3. Intellectual Property Rights and User Responsibilities
							</h2>
						</div>
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								3.1 User Content Ownership: Users are responsible for ensuring
								they possess the necessary rights to all documents, images, and
								any other content they upload to the Service. The Company does
								not claim ownership over content created or uploaded by users
								but requires that users guarantee they have the appropriate
								ownership or licensing rights for the content they contribute.
							</p>
						</div>
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								3.2 Search Functionality and Image Licensing: Our Service's
								search functions may return images or content that are subject
								to copyright and may require a license for use. Users are
								responsible for determining if the content requires a license
								for their intended use and for obtaining such a license if
								necessary. The Company provides no warranties regarding the
								copyright status or licensing requirements of content returned
								through search functions.
							</p>
						</div>
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								3.3 Limited License for Use: The Company grants users a limited,
								non-exclusive, non-transferable, revocable license to access and
								use the Service for personal and non-commercial purposes, in
								compliance with these terms. This license does not extend to
								copying, modifying, distributing, selling, or leasing any part
								of the Service or its content, nor does it allow the use of
								automated systems or software to extract data from the Service,
					...
					<div className='max-w-3xl mx-auto pb-4'>
						...
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								7.1 Refund Policy: If you have purchased the product on our
								platform, please note that all transactions are non-refundable.
								For purchases made through other platforms, the refund policy is
								subject to the terms and conditions of that specific platform.
							</p>
						</div>
						<div className='pb-4'>
							<p className='text-base text-gray-600'>
								7.2 Cancellation Policy: If you have paid for the product on our
								platform, you have the right to cancel your subscription at any
								time. You will continue to have access to premium features until
								the end of the billing period (month or year), after which your
