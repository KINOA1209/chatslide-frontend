    ...
    <section className="bg-gradient-to-b from-gray-100 to-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">2. Intellectual Property</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
                2.1 Ownership: All content, including but not limited to text,
                graphics, logos, images, audio clips, video clips, and software,
                provided on the Service is owned or licensed by the Company and
            ...
            <div className="pb-4">
              <p className="text-base text-gray-600">
                2.2 Limited License: We grant you a limited, non-exclusive,
                non-transferable, revocable license to access and use the
                Service for personal and non-commercial purposes. You may not
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">3. User-Generated Content</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
                3.1 Responsibility: You are solely responsible for any content
            ...
            <div className="pb-4">
              <p className="text-base text-gray-600">
                3.2 Prohibited Content: You agree not to post or share any
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">4. Privacy</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
                4.1 Privacy Policy: Our collection, use, and disclosure of your
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">5. Limitation of Liability</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
                5.1 Disclaimer: The Service is provided on an "as is" and "as
            ...
            <div className="pb-4">
              <p className="text-base text-gray-600">
                5.2 Limitation of Liability: In no event shall the Company or
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">6. Modifications to Terms</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
                6.1 Updates: We reserve the right to update or modify these
          ...
          <div className="max-w-3xl mx-auto pb-4">
            <div className="pb-8">
              <h2 className="h3 text-2xl">7. Governing Law</h2>
            </div>
            <div className="pb-4">
              <p className="text-base text-gray-600">
