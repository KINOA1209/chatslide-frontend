						...
						<div className='flex flex-col md:flex-row items-center pb-8'>
							<div>
								...
								<p className='text-base text-gray-600'>
									...
									<br />
									- A vibrant workspace fostering creativity.
									<br />
									- Collaborate with AI and education veterans.
									<br />
									- Directly impact global learners with your designs.
									<br />
									- Access to the latest in edtech and design.
									<br />
									- Competitive pay with avenues for growth at DrLambda.
									<br />
									<br />
									Eager to redefine education with your design finesse? Apply
									now for the UX Design Internship at DrLambda!
									<br />
									<br />
									...
									<br />
									<br />
									Note: DrLambda champions diversity and inclusivity. We welcome
									all applicants.
								</p>
							</div>
						</div>
						...
						<div className='flex flex-col md:flex-row items-center pb-8'>
							<div>
								...
								<p className='text-base text-gray-600'>
									...
									<strong>Our Promise:</strong>
									<br />
									- A stimulating environment nurturing innovation.
									<br />
									- Collaborate with seasoned professionals in the tech domain.
									<br />
									- A chance to shape the future of our web applications.
									<br />
									- Access to continuous learning and professional growth.
									<br />
									- Competitive compensation and benefits.
									<br />
									<br />
									Ready to elevate our web experiences with your coding
									artistry? Apply now for the Frontend Developer position!
									<br />
									<br />
									<strong>How to Apply:</strong>
									<br />
									Kindly forward your resume, portfolio, and a cover letter
									elucidating your passion and fit for the role. Direct your
									applications to{' '}
									<a href='mailto:contact@drlambda.ai'>contact@drlambda.ai</a>.
									<br />
									<br />
									Note: We are an equal opportunity employer, ardently
									championing diversity and inclusivity. All talented developers
