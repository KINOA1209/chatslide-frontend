      ...
      >
        ...
        {currentProjects.map((project, index) => (
          <React.Fragment key={project.id}>
            ...
            <div
              className='p-2 flex cursor-pointer items-center text-start border-b-2 text-ellipsis overflow-hidden text-gray-600 text-[17px] italic font-creato-medium leading-normal tracking-wide'
