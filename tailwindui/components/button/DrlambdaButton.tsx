...
export const UserOnboardingButton: React.FC<UserOnboardingButtonProps> = ({
	...
	return (
		<button
			onClick={onClick}
			className={`fixed top-[13rem] z-50 right-4 min-w-[10rem] lg:min-w-[12rem] px-2 h-[36px] rounded-[15px] flex justify-center items-center gap-2 cursor-pointer bg-Blue`}
		>
			<span className='text-white font-semibold tracking-tight whitespace-nowrap'>
				{' '}
