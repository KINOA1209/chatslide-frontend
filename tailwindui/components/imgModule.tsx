...
export const ImgModule = ({
    ...
    const handleImageSearchSubmit = async (
        ...
        const response = await fetch('/api/search_images', {
            ...
            body: JSON.stringify({
                search_keyword: (e.target as HTMLFormElement).search_keyword
                    .value,
            }),
        })
            .then((response) => {
        ...
        <div className='w-full h-full flex flex-col'>
            ...
            >
                ...
                >
                    ...
                    />
                    <div
                        className='h-[22px] ml-[14px] my-auto mr-2'
                        hidden={!searching}
                    >
                        <LoadingIcon />
                    </div>
        ...
        <>
            ...
            {createPortal(
                ...
                >
                    ...
                    >
                        <h4 className='font-semibold text-xl text-center mb-3'>
                            Image
                        </h4>
                        <div className='grow mt-4 flex flex-col overflow-hidden'>
                            ...
                            <div className='mt-3 mb-5 grow overflow-hidden'>
                                ...
                                {selectedQueryMode == ImgQueryMode.SEARCH &&
                                    imgSearchDiv}
