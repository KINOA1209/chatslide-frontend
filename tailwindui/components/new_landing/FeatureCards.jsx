  ...
  return (
    <>
      <div className='grid grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-4'>
        <div className='w-auto lg:w-[35rem] bg-gray-200 rounded-3xl flex flex-col px-8 py-6 mx-[1rem]'>
          <div className='w-auto lg:w-[27rem] opacity-95 text-neutral-800 text-2xl lg:text-3xl font-bold font-creato-bold leading-10 tracking-wide'>
            Content Creation
          </div>
          <div className='w-auto lg:w-[31rem] pt-4 text-gray-700 text-lg lg:text-2xl font-normal font-creato-regular leading-10 tracking-wide'>
            Evolve your narrative. Tools tailored for visionary storytelling.
            From inspiration to impression.
          </div>
          <div className='w-auto py-[4rem] rounded-md self-center'>
            <img
          ...
          <div className='flex items-stretch justify-between border-t-2 border-gray-300 pt-10 gap-6'>
            <img
              className='w-12 h-12 lg:w-14 lg:h-14 rounded-full border'
              src='new_landing/imgs/person1.png'
            />
            <div className='w-auto text-slate-500 text-sm lg:text-xl font-normal font-creato-regular leading-7 tracking-wide'>
