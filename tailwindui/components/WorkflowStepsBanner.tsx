...
const WorkflowStepsBanner: FunctionComponent<YourComponentProps> = ({
  ...
  lastStep = false,
	...
	return (
		<>
			<div className='relative sticky top-0 w-full h-[80px] flex flex-col items-center w-full bg-Sky z-10'>
      ...
      <div className='relative sticky top-0 w-full h-[80px] flex items-center w-full bg-white z-10'>
