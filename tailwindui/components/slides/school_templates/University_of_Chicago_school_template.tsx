...
export const University_of_Chicago_school_template = ({
  user_name,
  title,
  topic,
  subtopic,
  ...
  const themeElements = loadCustomizableElements('UChicago' as TemplateKeys);
  const layoutConfigElements = loadLayoutConfigElements(
    'UChicago' as TemplateKeys,
