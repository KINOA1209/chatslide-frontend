...
const SocialPostRepostButton: React.FC<SocialPostRepostButtonProps> = ({
    ...
    const uploadToImgbb = async (imageDataUrl: string): Promise<string | null> => {
        ...
        try {
            const response = await fetch('https://api.imgbb.com/1/upload?key=1e7d9032fb1608a28fd6e4342f37b7f5', {
                method: 'POST',
                body: formData,
            });
