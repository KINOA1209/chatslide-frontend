...
import { templateDispatch as defaultTemplateDispatch } from '../slides/templateDispatch';

type socialMediaSlideContainerProps = {
...
const socialMediaSlideContainer: React.FC<socialMediaSlideContainerProps> = ({
    slides,
    currentSlideIndex,
    isViewing = false,
    isPresenting = false,
...
export default socialMediaSlideContainer;