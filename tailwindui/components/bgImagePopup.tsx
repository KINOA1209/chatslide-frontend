					...
					>
						<div className='px-10 mt-1'>
							...
							{selectedOption === 'default1' && (
								<img
									src='../../../../slidesBackground/theme1.jpg'
							...
							{selectedOption === 'default2' && (
								<img
									src='../../../../slidesBackground/theme2.jpg'
									style={{ width: '200px', height: '150px' }}
								/>
							)}
							<br />
							<label>
								<input
									type='radio'
									value='default3'
									checked={selectedOption === 'default3'}
									onChange={handleOptionChange}
								/>
								<span className='mx-2'>
									Work With Dr.Lambda: Knowledge Fusion
								</span>
							</label>
							{selectedOption === 'default3' && (
								<img
									src='../../../../slidesBackground/theme3.png'
									style={{ width: '200px', height: '150px' }}
								/>
							)}
							<br />
							<label>
								<input
									type='radio'
									value='default4'
									checked={selectedOption === 'default4'}
									onChange={handleOptionChange}
								/>
							...
							{selectedOption === 'default4' && (
								<img
									src='../../../../slidesBackground/theme4.png'
									style={{ width: '200px', height: '150px' }}
								/>
							)}
							<br />
							...
							{selectedOption === 'customize' && (
								<div>
									<label
										htmlFor='imageUpload'
										className='btn text-white font-bold bg-gradient-to-r from-blue-600  to-teal-500 mx-6'
									>
										Choose File
									</label>
									<span>{fileName}</span>
