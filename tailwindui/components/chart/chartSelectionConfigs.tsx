...
const chartSelectionConfigs: Record<string, ChartConfig> = {
  pie: {
    ...
    imgSrc: <DynamicChart chartType="pie" chartData={getChartData('pie')} isPrview={true}/>,
    chartType: 'pie',
    dataStructure: 'ValueDataPoint',
  },
  line:{
    displayName: 'Single Line Chart',
    imgSrc: <DynamicChart chartType="line" chartData={getChartData('line')} isPrview={true}/>,
    chartType: 'line',
    dataStructure: 'ValueDataPoint',
  },
  bar: {
    displayName: 'Bar Chart',
    imgSrc: <DynamicChart chartType="bar" chartData={getChartData('bar')} isPrview={true}/>,
    chartType: 'bar',
    dataStructure: 'ValueDataPoint'
  },
  // scatter: {
