...
const Modal: React.FC<ModalProps> = ({ children, showModal, setShowModal, position }) => {
    ...
    <>
      {showModal && (
        ...
        >
          ...
          <div ref={modalContentRef} className={`z-50 ${position} bg-white rounded-lg shadow w-128 max-h-[90vh] overflow-y-auto p-2 sm:p-4`}
