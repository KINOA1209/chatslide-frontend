...
const Modal: React.FC<ModalProps> = ({
	...
	return (
		...
		>
			...
			<Transition
				className={`${position} bg-white rounded-lg shadow max-w-full dpr:max-w-full max-h-full md:max-w-[90%] lg:max-w-[80%] xl:max-w-[70%] overflow-y-hidden mx-2 p-2 sm:p-4`}
				show={showModal}
