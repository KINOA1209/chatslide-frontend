  ...
  onCancel = () => {},
	...
	return (
		...
		>
			...
			<Transition
				className={`modal-dialog-box ${position} bg-white rounded-lg shadow max-w-full dpr:max-w-full max-h-full md:max-w-[90%] lg:max-w-[80%] xl:max-w-[70%] overflow-y-auto mx-2 p-2 sm:p-4`}
				show={showModal}
