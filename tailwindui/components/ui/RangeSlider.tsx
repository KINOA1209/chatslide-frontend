...
const RangeSlider: React.FC<RangeSliderProps> = ({ onChange, label, values, locked }) => {
    ...
    return (
            ...
            <div className="w-full mb-6">
                {label && <label className="block text-gray-700 mb-2"><b>{locked ? '🔒 ' : '⭐️ '}{label}</b>: {values[index]}</label>}
