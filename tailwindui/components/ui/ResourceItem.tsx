...
export const ResourceItem: React.FC<Resource> = ({ id, name, type, thumbnail_url }) => {
  return (
    <div key={id} className='h-full flex items-center justify-left w-full py-4 px-2'>
      <div className='min-w-[32px] max-w-[32px]'>
        {thumbnail_url ? getThumbnail(thumbnail_url) : <FileIcon fileType={type} />}
      </div>
