                ...
                >
                  ...
                  <div className="p-2 bg-white/90 mx-2 mb-2 rounded-lg flex flex-col h-full">
                    ...
                    <div className="w-full text-center text-md text-gray-700">
                      {!isMonthly ? 'for 2 months, then $199/year' : '1st month, then $19.9/month'}
                    </div>
                    ...
                    <div className="h-10 max-w-xs mx-auto sm:max-w-none flex-col flex justify-center items-center my-3">
                      <div>
                        {(!currentUser || (tier === 'FREE' || tier === '')) &&
                          <DrlambdaButton onClick={() => handleClick('plus')} showArrow={false}>
                            {getCta()}
                          </DrlambdaButton>
                        }
              ...
              <div className={`transition ease-in-out delay-150 hover:-translate-y-2 mx-2 grow basis-0 min-w-[260px] max-w-sm ${showPro ? 'block' : 'hidden'} md:block`}>
                ...
                >
                  ...
                  <div className="px-8 py-2 flex flex-row pr-3 items-center">
                    <div className="text-2xl text-white">Pro</div><GrayLabel bgColor="bg-gray-200">Most Popular</GrayLabel>
                  </div>
                  ...
                  <div className="p-2 bg-white/90 mx-2 mb-2 rounded-lg h-full flex flex-col">
                    ...
                    <div className="w-full text-center text-md text-gray-700">
                      {!isMonthly ? 'for 2 months, then $499/year' : '1st month, then $49.9/month'}
                    </div>
                    ...
                    <div className="h-10 max-w-xs mx-auto sm:max-w-none flex-col flex justify-center items-center my-3">
                      <div>
                        {(!currentUser || (tier === 'FREE' || tier === '')) &&
                          <DrlambdaButton onClick={() => handleClick('pro')} showArrow={false} bgColor="bg-gradient-to-r from-purple-500 to-purple-700">
                            {getCta()}
                          </DrlambdaButton>
                        }
