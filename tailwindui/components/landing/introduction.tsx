...
const InternalIntroduction = () => {
	...
	return (
		<section className='relative h-[100vh] max-h-[1000px] md:h-[75vh]'>
			...
			<div
				className='h-full absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none -z-1'
				aria-hidden='true'
			>
				<Image
					...
					<div className='text-center pb-12 md:pb-16'>
						<div className='max-w-3xl mx-auto'>
							...
							>
								<div>
									<a
										className='btn text-white font-bold bg-gradient-to-r from-blue-600  to-teal-500 w-full mb-4 sm:w-auto sm:mb-0 cursor-pointer'
