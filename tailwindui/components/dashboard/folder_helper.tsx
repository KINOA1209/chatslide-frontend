...
export function groupProjectsByFolder(
    ...
    const folderMap: { [key: string]: Project[] } = projects.reduce((acc: { [key: string]: Project[] }, project: Project) => {
    ...
    empty_folders.forEach(folderName => {
    ...
    const sortedFolders: Folder[] = Object.keys(folderMap).sort().map(key => ({
        folderName: key,
