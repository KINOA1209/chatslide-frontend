  ...
  const fetchTeamMembers = async () => {
    try {
      ...
      const membersList: TeamMember[] = [
        { id: data.owner.id, name: data.owner.username, email: data.owner.username, role: 'Owner' },
          ...
          {isOwner && (
            <>
              ...
              <div className="mb-4">
                ...
                <div className="mt-2">
                  <BigBlueButton onClick={() => handlePurchaseSeat("TEAM_ONE_SEAT", token)}>Purchase Seat</BigBlueButton>
                </div>
                <div className="mt-2">
                  <p>Currently maximum is {maxMembers}. Purchase new seat to increase the limit.</p>
                </div>
              </div>
            </>
          )}
