...
const FeedbackForm: React.FC<FeedbackFormProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed z-10 inset-0 overflow-y-auto hidden sm:block">
                        ...
                        {submitSuccessful ? (
                            <div className="flex flex-col items-center text-green-500">
                                ...
                                <p className="text-xl font-semibold text-center">
                                    ...
                                    {rating === 5 && (
                                        <span> Let your friends know you love DrLambda by referring them.</span>
                                    )}
                                </p>
                            </div>
                        ) : (
