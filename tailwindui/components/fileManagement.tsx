        ...
        return (
            ...
            >
                <div className='h-full flex items-center w-full py-4 px-2'>
                    ...
                    <div className='grow text-ellipsis mx-4 overflow-hidden whitespace-nowrap'>
                        {filename}
                    </div>
                    {timestamp && (
...
const NewFileManagement: React.FC<UserFileList> = ({
  selectable = false,
  userfiles,
  deleteCallback,
  clickCallback,
...
const MyFiles: React.FC<filesInterface> = ({
    ...
    return (
        <section className='bg-gradient-to-b from-gray-100 to-white grow flex flex-col h-full'>
            ...
            <div
                className={`max-w-6xl w-full mx-auto px-4 ${!selectable ? 'pt-16 md:pt-32' : ''
                ...
                {resources.length === 0 && (
                    <div className='w-full grow flex items-center justify-center'>
                        <div className='text-gray-400' ref={promptRef}>
                            You have no uploaded file, please click the upload button to upload a file or connect to storage.
                        </div>
                    </div>
                )}
            </div>
...
const NewMyFiles: React.FC<filesInterface> = ({
  selectable = false,
  callback,
}) => {
  const [currentPage, setCurrentPage] = useState(1)
  ...
  return (
    <section className='bg-gradient-to-b from-gray-100 to-white grow flex flex-col h-full'>
      <ToastContainer enableMultiContainer containerId={'fileManagement'} />
      {/* top background container of my Library title text and Upload new file button  */}
      ...
      <div
        className='max-w-7xl w-full mx-auto mt-4 px-4 pt-4 flex grow overflow-y-auto'
        ref={contentRef}
      >
        {resources.length > 0 && (
          <NewFileManagement
