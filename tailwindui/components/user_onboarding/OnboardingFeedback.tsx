...
export const OnboardingFeedbackForm: React.FC<FeedbackFormProps> = ({
	onClose,
	message,
	successDiv,
	textRequired,
					...
					<form onSubmit={handleSubmit} className='w-full mt-4'>
						...
						<div className='mt-4'>
							...
							<textarea
								...
								placeholder='Any thoughts or suggestions will be largely appreciated...'
							></textarea>
						</div>
