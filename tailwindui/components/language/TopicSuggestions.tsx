...
export const TOPIC_SUGGESTIONS = {
	EN: [
		'🦠 How to use ultraviolet light to kill germs',
		...
		'🌿 Tips for sustainable living and reducing waste',
		...
		'⏱ Improving productivity with the Pomodoro Technique',
		'💤 The science behind why we dream',
		'🏛 Discovering the world’s ancient civilizations',
		'📸 Photography tips for capturing nature’s beauty',
		'🗣 Learning a new language: Strategies and benefits',
